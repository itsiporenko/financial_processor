...
-	Create a Python project in github
-	Model the problem using OO principles.
-	Test the solution.
-	Send a link to your solution in your github
...
-	Use Python 3
-	You’re allowed to use Open Source libraries and frameworks of your choice.
...
- 	please use an Open Source and lightweight database (e.g. sqlite), memory or file-based - your choice, that doesn't require installation of any prerequisite software and can be launched and torn down as part of your implementation.
-	We must be able run your program simply by using a batch script provided by you; in particular:
